package com.example.RedisConnect.config
...
class RedisConfig(val msgListener: MessageListener) {
    ...
    fun redisContainer(): RedisMessageListenerContainer {
        ...
        container.addMessageListener(newMessageListener(), ChannelTopic("Gate"))
//        container.addMessageListener(newMessageListener(), ChannelTopic("micOne"))
        return container
    }
}